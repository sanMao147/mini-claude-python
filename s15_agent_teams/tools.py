...
TOOLS = [
    ...
    {"type":"function","function":{"name":"complete_task","description":"完成任务(in_progress→completed)",
        "parameters":{"type":"object","properties":{"task_id":{"type":"string"}},"required":["task_id"]}}},
    {"type":"function","function":{"name":"schedule_job","description":"注册定时任务","parameters":{"type":"object","properties":{"cron":{"type":"string"},"prompt":{"type":"string"},"durable":{"type":"boolean"}},"required":["cron","prompt"]}}},
    {"type":"function","function":{"name":"spawn_teammate","description":"创建一个队友Agent来协助完成任务","parameters":{"type":"object","properties":{"task":{"type":"string"}},"required":["task"]}}},
    {"type":"function","function":{"name":"send_message","description":"向队友发送消息","parameters":{"type":"object","properties":{"content":{"type":"string"},"summary":{"type":"string"}},"required":["content","summary"]}}},
    {"type":"function","function":{"name":"check_inbox","description":"检查收件箱中的队友消息","parameters":{"type":"object","properties":{},"required":[]}}},
]
...
TOOL_HANDLERS = {
    ...
    "schedule_job":None,"spawn_teammate":None,"send_message":None,"check_inbox":None,
}
