"""s07 tools.py — 8 个工具（新增 load_skill）"""
...
TOOLS = [
    ...
    # ── s07 新增: load_skill ──
    {"type": "function", "function": {"name": "load_skill", "description": "加载指定技能的完整使用说明。system prompt 中列出了可用的技能名称。",
...
TOOL_HANDLERS = {
    ...
    "todo_write": None, "task": None, "load_skill": None,
}
